...
class SwerveAutoBuilder:
    ...
    def wrappedEventCommand(self, eventCommand: commands2.Command) -> commands2.command:
    ...
    def getStopEventCommands(self, stopEvent: PathPlannerTrajectory.StopEvent) -> commands2.command:
        commands = []
    ...
    def fullAuto(self, trajectory: PathPlannerTrajectory) -> commands2.command:
